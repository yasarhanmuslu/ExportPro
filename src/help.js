    ...
    },
    {
        ...
        desc: `
            ...
            <ul>
                ...
                <li><strong>Tahsilatlar:</strong> Gelen ödemeler sipariş bazında gruplanır; her siparişin başlığında sipariş tutarı, tahsil edilen, siparişin faturaları (no · tarih · tutar) ve kalan bakiye görünür. Arama kutusu fatura numarasıyla da arar. Tahsilat faturaya değil siparişe dağıtılır — başlıktaki faturalar siparişin faturalarıdır, tek tek ödemelerin eşleşmesi değildir. Başlıktaki not simgesiyle siparişe not yazılır (Siparişler ekranındaki Notlar alanının aynısı; "Tarihli satır ekle" mevcut notu koruyarak yeni satır açar). Her tahsilat satırındaki kalem simgesiyle ödeme tarihi, yolu, banka hesabı, referansı ve notu düzeltilir; tutar değişmez — tutar yanlışsa tahsilat silinip yeniden girilir. "Tarihsiz" kayıtlar sistem öncesi ödemelerdir; "Tarih gir" ile arşiv için tarihlendirilebilir. Dağıtılmamış tutar müşteri avansıdır; "Dağıt" ile sonraki siparişe mahsup edilir.</li>
